...
app.layout = html.Div(
    [
        ...
        html.Div([
            dcc.Markdown("""If you know your Representatives or Senators, \
                         select them in the dropdownbox below. \
                         If you want to lookup who your representatives are, \
                         check out 
                         [this website](https://www.house.gov/representatives/find-your-member)"""),
        ...
        html.Div([
            dcc.Tabs([
                dcc.Tab(label = 'Biographical Info',
                        children=[
...
def biotable(b): #Step 3: Function that turns input to output
    myquery =f'''
    SELECT *
    FROM members
    WHERE bioguide_id = '{b}'
    ...
    return [ff.create_table(member_info.T.rename({'index': '',0:''},axis = 1).reset_index())]
