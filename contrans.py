...
class contrans:
    ...
    def __init__(self):
        ...
        self.MANGO_INITDB_ROOT_USERNAME = os.getenv("MONGO_INITDB_ROOT_USERNAME")
...
# build crosswalk with ideology
    def get_crosswalk(self):
        ...
        ideology = ideology.drop(columns = ['party_code'], axis = 1)
...
#vote similarity matrix
    ...
    def vote_similarity_to_member(self, memberinfo):
        ...
        vote_compare = vote_compare.sort_values(by = 'agree', ascending = False)
